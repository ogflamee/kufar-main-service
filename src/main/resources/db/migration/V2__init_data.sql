...
(3,'Samsung S21','процессор intel. стандоффчик 60 фпс стабильно.',500,'Minsk',7,'ACTIVE',3,1,NOW()),
...
(8,'Camera Canon','комплектом отдам карту памяти на 64GB.',700,'Minsk',15,'ACTIVE',2,1,NOW()),
